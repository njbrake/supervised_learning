...
This will open up the jupyter notebook in your browser, at which point you can select the "run all cells option" in order to generate all statistics for both heart and mobile phone datasets. Enjoy!
